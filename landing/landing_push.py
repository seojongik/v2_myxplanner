...
def main():
    ...
    print(f"대상 폴더: landing/")
    print()
    
    # 1. landing/ 폴더의 변경사항만 확인
    ...
    if not status_output:
        print_error("landing/ 폴더에 변경사항이 없습니다.")
        sys.exit(0)
    ...
    run_command(['git', 'add', 'landing/'], cwd=project_root)
    print_success("스테이징 완료 (landing/ 폴더만)")
    print()
