...
export function FAQs() {
  ...
  const faqs = [
    ...
    {
      category: '서비스 일반',
      question: '여러 지점을 운영하는데 모두 관리할 수 있나요?',
      answer: '네, 가능합니다. 하나의 계정으로 여러 지점을 통합 관리할 수 있으며, 지점별 매출, 회원, 예약 현황을 한눈에 비교할 수 있습니다. 각 지점별로 별도의 관리자 권한 설정도 가능합니다.'
    },
    {
      category: '연동 및 설치',
  ...
  return (
    <section id="faqs" className="py-20 px-3 md:px-4 bg-gray-50">
